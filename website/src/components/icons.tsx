...
export { Mail, ArrowUpRight } from "lucide-react";

type IconProps = SVGProps<SVGSVGElement>;

/**
 * Brand icons are not shipped by lucide-react (trademark reasons), so we
 * provide minimal, accessible SVG marks that match lucide's stroke style.
 */
